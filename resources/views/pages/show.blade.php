...
@section('content')
    <h4>
        <a href="/learnlaravel5.3/public/">⬅️返回首页</a>
    </h4>

    <h1 style="text-align: center; margin-top: 50px;">{{ $page->title }}</h1>
    <hr>
    <div id="date" style="text-align: right;padding-right: 10px;">
        {{ $page->updated_at }}
    </div>
    ...
    <div id="comments" style="margin-bottom: 100px;">
        ...
        <div id="new" style="padding-left: 10px;padding-right: 10px;">
